...
(function ($) {
  RedactorPlugins.searchreplace = function () {
    ...
    function getTemplate() {
      ...
      + '<div><input type="checkbox" id="redactor-search-replace-ignore-case" ><label for="redactor-search-replace-ignore-case">' + 'Ignore Case' + '</label></div>'
      + '<div><input type="checkbox" id="redactor-search-replace-word-boundary" ><label for="redactor-search-replace-word-boundary">' + 'Match at Word Boundary' + '</label></div>'
      + '<div><input type="checkbox" id="redactor-search-replace-only-selection" ><label for="redactor-search-replace-word-boundary">' + 'Search Only in Selection' + '</label></div>'
      + '</section>';
    }
